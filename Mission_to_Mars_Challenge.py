...
Using Jupyter Notebooks and Python along with ChromeDriver for scraping 
and MongoDB and Flask to display data."""
...
# And now downloaded as .py file and cleaned up.
